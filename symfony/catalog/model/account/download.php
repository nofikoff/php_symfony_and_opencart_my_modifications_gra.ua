...
class ModelAccountDownload extends Model {
    ...
    public function getDownloadImages() {
        $query = $this->db->query("SELECT d.image, dd.name, dd.link_href FROM " . DB_PREFIX . "download d INNER JOIN " . DB_PREFIX . "download_description dd ON dd.download_id = d.download_id ORDER BY d.download_id LIMIT 10");
