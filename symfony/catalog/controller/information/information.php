...
//		
		...
		if ($information_info) {
	  		$this->document->title = $information_info['title'] . ' | '. $this->language->get('title');
            if($information_info['information_category_id'])
                $this->document->breadcrumbs[] = array(
                    'href'      => $this->model_tool_seo_url->rewrite(HTTP_SERVER . 'index.php?route=information/information_category&type=' . $information_info['information_category_id']),
