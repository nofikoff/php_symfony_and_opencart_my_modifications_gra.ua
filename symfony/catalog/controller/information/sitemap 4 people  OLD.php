...
class ControllerInformationSitemap extends Controller {
	public function index() {
		...
		$this->data['special'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=product/special');
		$this->data['account'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=account/account');
    	$this->data['edit'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=account/edit');
    	$this->data['password'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=account/password');
    	$this->data['address'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=account/address');
    	$this->data['history'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=account/history');
    	$this->data['download'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=account/download');
    	...
    	$this->data['search'] = $this->model_tool_seo_url->rewrite(HTTP_SERVER . 'index.php?route=product/search');
