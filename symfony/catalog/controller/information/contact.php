  	...
  	public function index() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$mail->setTo($this->config->get('config_email'));
	  		...
	  		$this->redirect($this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=information/contact/success'));
    	}
      	...
      	$this->document->breadcrumbs[] = array(
        	'href'      => $this->model_tool_seo_url->rewrite(HTTP_SERVER . 'index.php?route=information/contact'),
		...
		$this->data['action'] = $this->model_tool_seo_url->rewrite(HTTP_SERVER . 'index.php?route=information/contact');
