...
class ControllerCheckoutCart extends Controller {
	...
	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'GET' && isset($this->request->get['product'])) {
			...
			$this->redirect($this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=checkout/cart'));
    	...
    	if ($this->cart->hasProducts()) {
			...
			$this->data['action'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=checkout/cart');
			...
			$this->data['checkout'] = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=checkout/symple_order');
