	...
	protected function index() {
		...
		foreach ($results as $result) {
			...
			if ($options) {
				...
				$add = $this->model_tool_seo_url->rewrite(HTTPS_SERVER . 'index.php?route=checkout/cart&amp;product_id=' . $result['product_id']);
			}
		...
		if ($this->config->get('latest_position') == 'home') {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/product_list_home.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/module/product_list_home.tpl';
			} else {
				$this->template = 'default/template/module/product_list_home.tpl';
			}
		} else {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/product_list.tpl')) {
				...
				$this->template = 'default/template/module/product_list.tpl';
			}
		}
