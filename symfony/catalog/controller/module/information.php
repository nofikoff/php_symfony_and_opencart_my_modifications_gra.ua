...
class ControllerModuleInformation extends Controller {
	protected function index() {
		...
		foreach ($this->model_catalog_information->getInformations($this->config->get('information_information_category')) as $result) {
      		$this->data['informations'][] = array(
        		'title' => $result['title'],
        ...
        $this->data['teh'] = $this->model_tool_seo_url->rewrite(HTTP_SERVER . 'index.php?route=information/teh');
